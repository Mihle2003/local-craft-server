...
const uri = `mongodb+srv://bomvumihle:cjpkX3NkILELh61B@localcraft.bnan9.mongodb.net/?retryWrites=true&w=majority&appName=localCraft`;
...
async function run() {
    try {
        ...
        const database = client.db("local_craft");
